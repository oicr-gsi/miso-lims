...
import uk.ac.bbsrc.tgac.miso.core.service.printing.context.impl.XeroxSpoolPrintContext;
 ...
 * @since 0.0.3
 */
public class XeroxSpoolPrintStrategy implements PrintStrategy<String, XeroxSpoolPrintContext> {
  protected static final Logger log = LoggerFactory.getLogger(XeroxSpoolPrintStrategy.class);

  @Override
  public boolean print(String content, XeroxSpoolPrintContext context) throws IOException {
    try {
