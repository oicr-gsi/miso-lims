...
import uk.ac.bbsrc.tgac.miso.core.service.printing.factory.XeroxFileGeneratingBarcodeLabelFactory;
 ...
 */
@ServiceProvider
public class XeroxStandardTubeBarcodeLabelSchema implements BarcodableSchema<File, Barcodable> {
  protected static final Logger log = LoggerFactory.getLogger(XeroxStandardTubeBarcodeLabelSchema.class);
  private BarcodeLabelFactory<File, Barcodable, BarcodableSchema<File, Barcodable>> XeroxbarcodeLabelFactory = new XeroxFileGeneratingBarcodeLabelFactory<Barcodable>();

  @Override
  public String getName() {
    return "XeroxStandardTubeBarcodeLabelSchema";
  }
  ...
  public File getPrintableLabel(Barcodable barcodable) {
    return XeroxbarcodeLabelFactory.getLabel(this, barcodable);
  }

  @Override
  public BarcodeLabelFactory getBarcodeLabelFactory() {
    return XeroxbarcodeLabelFactory;
  }
