...
public class BiotechLibraryAliasGenerator implements NameGenerator<Library> {

  private static final String sampleRegex = "^([MF\\d]{2,5})_([S\\d]{2,5})_([L])_([a-zA-Z\\d]{3,20}).*";
