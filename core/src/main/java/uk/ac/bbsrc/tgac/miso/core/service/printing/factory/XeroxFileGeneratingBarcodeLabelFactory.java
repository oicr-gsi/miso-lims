 ...
 */
@ServiceProvider
public class XeroxFileGeneratingBarcodeLabelFactory<T> implements BarcodeLabelFactory<File, T, BarcodableSchema<File, T>> {
  protected static final Logger log = LoggerFactory.getLogger(XeroxFileGeneratingBarcodeLabelFactory.class);
