...
public class SQLLibraryDAO implements LibraryStore {
  ...
  public static final String LIBRARIES_SELECT = "SELECT libraryId, name, description, alias, accession, securityProfile_profileId, sample_sampleId, identificationBarcode, "
      + "locationBarcode, paired, libraryType, librarySelectionType, libraryStrategyType, platformName, concentration, creationDate, qcPassed, boxPositionId "
      + "FROM " + TABLE_NAME;
  ...
  public static final String LIBRARY_UPDATE = "UPDATE "
      ...
      + "platformName=:platformName, concentration=:concentration, creationDate=:creationDate, qcPassed=:qcPassed, emptied=:emptied, volume=:volume "
  ...
  public static final String LIBRARIES_SELECT_BY_SAMPLE_ID = "SELECT l.libraryId, l.name, l.description, l.alias, l.accession, l.securityProfile_profileId, l.sample_sampleId, l.identificationBarcode, l.locationBarcode, "
      + "l.paired, l.libraryType, l.librarySelectionType, l.libraryStrategyType, l.platformName, l.concentration, l.creationDate, l.qcPassed, l.boxPositionId "
  ...
  public static final String LIBRARIES_BY_RELATED_DILUTION_ID = "SELECT p.library_libraryId, l.libraryId, l.name, l.description, l.alias, l.accession, l.securityProfile_profileId, l.sample_sampleId, l.identificationBarcode, l.locationBarcode, "
      + "l.paired, l.libraryType, l.librarySelectionType, l.libraryStrategyType, l.platformName, l.concentration, l.creationDate, l.qcPassed, l.qcPassed, l.boxPositionId "
  ...
  public long save(Library library) throws IOException {
    ...
    params.addValue("alias", library.getAlias()).addValue("accession", library.getAccession())
        ...
        .addValue("creationDate", library.getCreationDate()).addValue("emptied", library.isEmpty()).addValue("volume", library.getVolume());
